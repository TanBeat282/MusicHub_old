package com.example.musichub.adapter.Lyric;
...
import com.example.musichub.model.song.Word;

import java.util.ArrayList;

public class WordsAdapter extends RecyclerView.Adapter<WordsAdapter.WordViewHolder> {
    private ArrayList<com.example.musichub.model.song.Word> words;
    ...
    public void onBindViewHolder(@NonNull WordViewHolder holder, int position) {
        com.example.musichub.model.song.Word word = words.get(position);
