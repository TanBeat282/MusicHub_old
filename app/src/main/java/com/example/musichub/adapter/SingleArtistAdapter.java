...
public class SingleArtistAdapter extends RecyclerView.Adapter<SingleArtistAdapter.ViewHolder> {
    ...
    public SingleArtistAdapter(ArrayList<DataPlaylist> dataPlaylistArrayList, Activity activity, Context context) {
