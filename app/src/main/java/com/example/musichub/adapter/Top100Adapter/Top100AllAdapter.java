...
public class Top100AllAdapter extends RecyclerView.Adapter<Top100AllAdapter.ViewHolder> {
    ...
    public Top100AllAdapter(ArrayList<DataPlaylist> itemsTop100s, Context context) {
